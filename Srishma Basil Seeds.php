            ...
            <div class="productbox">
                <div class="allimages">
                    <div class="smallimages">
                        <img src="product-images/BASIL SEEDS/1.jpg" onclick="clickimg(this)" />
                        <img src="product-images/BASIL SEEDS/3.jpg" onclick="clickimg(this)" />
                        <img src="product-images/BASIL SEEDS/4.jpg" onclick="clickimg(this)" />
                    </div>
                    <div class="main-images">
                        <img src="product-images/BASIL SEEDS/1.jpg" id="imagebox" />
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <p class="Product-name">Srishma Basil Seeds</p>
                </div>
                <div class="pricebox">
                    ...
                    <p>
                        <b>Description: </b>
                        Discover the natural goodness of Srishma Basil Seeds. Raw and unprocessed, these seeds are
                        packed with health benefits and versatile in their use. Add them to your favorite beverages for
                        a refreshing twist or sprinkle over salads for added nutrition. With Srishma Basil Seeds,
                        elevate your wellness routine effortlessly. Experience the pure essence of nature in every seed.
                    </p>
                </div>
